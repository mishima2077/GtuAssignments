...
/**
 * A class for visualizing data in a graph
 */
public class GUIVisualization extends JFrame {
    ...
    public GUIVisualization(String graphName,String plotType, List<Integer> dataPointsX, List<Long> dataPointsY) {
        ...
        setTitle(graphName); // Set the title of the window
